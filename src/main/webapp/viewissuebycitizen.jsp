...
<body>
  ...
  <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Enter Issue Type">
   <table border="2" id="myTable">
        ...
        <c:forEach items="${issues}" var="citizen">
            <tr>
                <td><c:out value="${citizen.title}"/></td>
                <td><c:out value="${citizen.description}"/></td>
                <td><c:out value="${citizen.issueType}"/></td>
                <td><c:out value="${citizen.location}"/></td>
                <td><c:out value="${citizen.reportedBy}"/></td>
                <td><c:out value="${citizen.constituency}"/></td>
                <td><c:out value="${citizen.createdDate}"/></td>
                <td><c:out value="${citizen.urgencyLevel}"/></td>
